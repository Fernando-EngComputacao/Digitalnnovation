...
<html lang="pt-br">
	...
	<body bgcolor="#fcfcff">
		...
		elseif(isset($_GET['vari'])){
		 ...
		 echo "</div>";			}
	?>
	<form action="resposta_pecas.php" method="POST" enctype="multipart/form-data" autocomplete="off">
    <div id='left'>
	<center>
        ...
        <font class="fontecadastro left">Descrição:</font><br>
        <input class='input right' type="text" name="descricao" id="descricao" value="" required autocomplete="off"><br>
		</center>

		</div>
		<div id="right">
		<center>
        <font class="fontecadastro left">Quantidade:</font><br>
        <input class='input right' type="number" name="quantidade" value="1" id="quantidade" value="" required autocomplete="off"><br>
