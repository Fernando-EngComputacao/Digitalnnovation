...
<html lang="pt-br">
	...
	<body bgcolor="#fcfcff">
		...
		elseif(isset($_GET['vari'])){
		 ...
		 echo "</div>";			}
	?>
	<form action="respostaCadastro.php" method="POST" enctype="multipart/form-data" autocomplete="off">
    <div id='left'>
	<center>
        ...
        <font class="fontecadastro left">Login:</font><br>
        <input class='input left' type="text" name="login" id="login" value="<?php echo $login; ?>" required autocomplete="off"><br>
        <font class="fontecadastro left">Senha:</font><br>
        <input class='input left' type="password" name="senha" id="senha" required autocomplete="off"><br>
		<font class="fontecadastro left">Confirmar Senha:</font><br>
        <input class='input left' type="password" name="confirmsenha" id="confirmsenha" required autocomplete="off"><br>
