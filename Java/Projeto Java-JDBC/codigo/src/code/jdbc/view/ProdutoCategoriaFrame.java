...
import code.jdbc.controller.CategoriaController;
import code.jdbc.controller.ProdutoController;
import code.jdbc.modelo.Categoria;
import code.jdbc.modelo.Produto;
...
public class ProdutoCategoriaFrame extends JFrame {
	...
	public ProdutoCategoriaFrame() {
		...
		labelNome.setBounds(10, 10, 300, 15);
		labelDescricao.setBounds(10, 50, 300, 15);
		labelCategoria.setBounds(10, 90, 300, 15);
